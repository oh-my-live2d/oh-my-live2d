...
import { getWindowSizeType, handleCommonStyle, onChangeWindowSize } from '../utils/index.js';

export class Models {
  private model?: Live2DModel<InternalModel>; // 当前模型实例
  ...
  create(onError: (e: Error) => void): void {
    this.model = this.live2dModel.fromSync(this.currentModelOptions.path, {
