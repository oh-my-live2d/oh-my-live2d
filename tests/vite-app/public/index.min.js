...
`,H=function(i){const{message:t}=i;let e="";const s=new Date().getHours().toString(),n=/^[5-7]$/,a=/^(?:[8-9]|1[0-1])$/,d=/^(1[2-3])$/,y=/^1[4-7]$/,I=/^1[8-9]$/,x=/^2[0-1]$/,M=/^2[2-3]$/;return n.test(s)?e=t.daybreak:a.test(s)?e=t==null?void 0:t.morning:d.test(s)?e=t==null?void 0:t.noon:y.test(s)?e=t==null?void 0:t.afternoon:I.test(s)?e=t==null?void 0:t.dusk:x.test(s)?e=t==null?void 0:t.night:M.test(s)?e=t==null?void 0:t.lateNight:e=t==null?void 0:t.weeHours,e},$=()=>console.log(`
